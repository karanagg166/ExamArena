...
const pillars = [
    {
        title: "Students",
        description: "Take exams, view results, and manage your class progress in one place.",
        icon: GraduationCap,
    },
    {
        title: "Teachers",
        description: "Create and review exams with cleaner workflows and structured data.",
        icon: Sparkles,
    },
    {
        title: "Principals",
        description: "Organize school and class operations with role-aware controls.",
        icon: ShieldCheck,
    },
];
        ...
        <main className="page-shell text-white">
            <section className="mx-auto max-w-5xl">
                <div className="rounded-3xl border border-zinc-800/80 bg-zinc-950/60 px-6 py-12 text-center shadow-2xl shadow-indigo-950/15 md:px-10 md:py-16">
                    <p className="mb-3 text-xs font-semibold uppercase tracking-[0.24em] text-indigo-300">Exam Arena</p>
                    ...
                    <p className="mx-auto mt-4 max-w-2xl text-sm text-zinc-400 md:text-base">
                        Unified workflows for students, teachers, and principals with secure auth and role-based pages.
                    </p>
