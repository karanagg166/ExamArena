...
export default function SignupPrincipalPage() {
      ...
      <div className="page-shell flex min-h-screen items-center justify-center text-white">
        <Card className="w-full max-w-xl shadow-2xl shadow-indigo-950/20">
          <CardHeader className="text-center">
            <Badge
              variant="danger"
              className="mx-auto uppercase tracking-widest"
            >
              Step 2 of 2
            </Badge>
  ...
  return (
    <div className="page-shell flex min-h-screen items-center justify-center text-white">
      <Card className="w-full max-w-xl shadow-2xl shadow-indigo-950/20">
        <CardHeader className="text-center">
          <Badge className="mx-auto uppercase tracking-widest">
            Step 2 of 2
          </Badge>
          <CardTitle className="mt-2 text-2xl">Principal Account</CardTitle>
          <CardDescription>
            You are all set! Choose how you want to proceed.
          </CardDescription>
        </CardHeader>
        <CardContent>
          <div className="grid grid-cols-1 gap-4">
            ...
            >
              ...
              <span>
                ...
                <span className="text-sm font-normal text-indigo-100/80">
