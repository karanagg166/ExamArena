        ...
        <div className="page-shell flex min-h-screen items-center justify-center py-12 text-white">
            <Card className="w-full max-w-xl shadow-2xl shadow-indigo-950/20">
                <CardHeader>
                    ...
                    <CardTitle className="text-2xl">Complete your Teacher profile</CardTitle>
                ...
                <CardContent>
                    <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {availableQualifications.length > 0 ? availableQualifications.map((qual) => (
                                    <Button
                                        ...
                                        variant={form.qualifications.includes(qual) ? "primary" : "outline"}
                                        className="h-9"
                                    >
                                        {qual}
                                    </Button>
                            ...
                            <div className="flex flex-wrap gap-2">
                                {availableSubjects.length > 0 ? availableSubjects.map((sub) => (
                                    <Button
                                        ...
                                        variant={form.subjects.includes(sub) ? "primary" : "outline"}
                                        className="h-9"
                                    >
                                        {sub}
                                    </Button>
                        ...
                        <Button type="submit" disabled={saving} className="mt-4 w-full" size="lg">
