  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-black px-4 text-white py-12">
      <div className="w-full max-w-2xl bg-zinc-950 border border-zinc-800 p-8 rounded-3xl shadow-2xl">
        ...
        {message.text && (
          <div
            className={`p-3 rounded-xl mb-6 text-sm text-center ${message.type === "error" ? "bg-red-500/10 text-red-400 border border-red-500/20" : "bg-green-500/10 text-green-400 border border-green-500/20"}`}
          >
            {message.text}
          </div>
        )}
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            <label className="text-sm font-medium text-zinc-300 ml-1 block mb-1.5">
              School Name
            </label>
            <input
              name="name"
