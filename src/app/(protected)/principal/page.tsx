        ...
        >
          <div>
            ...
            <input
              ...
              onChange={(e) =>
                setForm({ experience: parseInt(e.target.value) || 0 })
              }
              className={INPUT_CLS}
            />
          </div>
          <div className="flex gap-3 pt-2">
            ...
            <a
              href="/profile"
              className="flex items-center px-5 py-3 bg-zinc-800 hover:bg-zinc-700 rounded-xl text-sm font-medium transition-all"
            >
              ← Account Settings
            </a>
          </div>
