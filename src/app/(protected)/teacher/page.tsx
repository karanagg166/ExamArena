        ...
        <div className="min-h-screen bg-black text-white p-6">
            <div className="max-w-2xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-zinc-400 mt-1 text-sm">Update your professional details.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="bg-zinc-950 border border-zinc-800 rounded-2xl p-6 space-y-6">
                    {/* Basic Info */}
                    <div className="grid grid-cols-2 gap-4">
                        <div>
                            <label className="text-sm text-zinc-400 block mb-1">Department</label>
                            <input
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {availableQualifications.length > 0 ? availableQualifications.map((qual) => (
                                ...
                                <p className="text-sm text-zinc-500 italic">No qualifications available to select.</p>
                            )}
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="flex flex-wrap gap-2">
                            {availableSubjects.length > 0 ? availableSubjects.map((sub) => (
                                ...
                                <p className="text-sm text-zinc-500 italic">No subjects available to select.</p>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="flex gap-3 pt-4">
                        ...
                        <button type="button" onClick={() => router.push("/profile")} className="flex items-center px-5 py-3 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 rounded-xl text-sm font-medium transition-all">
                            Cancel
                        </button>
                    </div>
                </form>
